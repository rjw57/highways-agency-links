...
$(document).ready(function() {
  ...
  fetchData.then(function(trafficData) {
    ...
    var pch = new PostComposeHandler(trafficData);
    console.log(pch);
    map.on('postcompose', pch.handleEvent.bind(pch) );
...
function PostComposeHandler(trafficData) {
  this.trafficData = trafficData;
  return this;
}

PostComposeHandler.prototype.updateCache = function(event) {
